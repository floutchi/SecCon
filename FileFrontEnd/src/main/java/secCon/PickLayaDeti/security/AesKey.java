...
public class AesKey {
        static String password = "This is a plain text which need to be encrypted by Java AES 256 GCM Encryption Algorithm";
        ...
        public static void main(String[] args) throws Exception
        {
            ...
            byte[] cipherText = encrypt(password.getBytes(), key, IV);
